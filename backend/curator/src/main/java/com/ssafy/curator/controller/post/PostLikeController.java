...
public class PostLikeController {
    ...
    // 좋아요 누르기
    @PostMapping("/{postId}")
    String like(@RequestParam String username, @PathVariable int postId) {
        return postLikeService.like(username, postId);
    }
    ...
    String deleteLike(@RequestParam String username, @PathVariable int postId) {
        return postLikeService.deleteLike(username, postId);
    }
